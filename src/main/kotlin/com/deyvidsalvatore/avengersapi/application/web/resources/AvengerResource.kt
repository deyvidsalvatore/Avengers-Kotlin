...
import com.deyvidsalvatore.avengersapi.domain.avenger.AvengerRepository
...
class AvengerResource(
    ...
    @GetMapping
    fun getAvengers() = repository.getAvengers().map { AvengerResponse.from(it) }.let { ResponseEntity.ok().body(it) }
